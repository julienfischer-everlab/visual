...
| [`evlab-gift-unwrap`](evlab-gift-unwrap/) | Unwrap gift-FINAL (formerly "Unwrap your Everlab gift") — the gift page linked from a gift email: the only gift page kept; earlier variants (sections, split duplicate) are in git history | 2026-09-09, "Smaller seed" | Shared with organization |
