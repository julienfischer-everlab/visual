...
| [`evlab-gift-unwrap`](evlab-gift-unwrap/) | Unwrap your Everlab gift — the cinematic reveal linked from a gift email | 2026-09-08, "Phone: bigger headline, big dome, floating button" | Private |
| [`evlab-gift-sections`](evlab-gift-sections/) | Your Everlab gift — the same gift as a static, section-based page | 2026-09-09, "Top bar, six inclusion cards" | Private |
