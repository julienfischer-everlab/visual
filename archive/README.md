...
| [`evlab-gift-unwrap`](evlab-gift-unwrap/) | Unwrap your Everlab gift — the cinematic reveal linked from a gift email | 2026-09-08, "256px exit, phone offset, third version" | Private |
...
| [`evlab-gift-split`](evlab-gift-split/) | Unwrap your Everlab gift · Split — the reveal with the card on the left and the membership over the photo on the right | 2026-09-09, "Version select complete" | Private |
