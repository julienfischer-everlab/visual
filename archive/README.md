...
| [`evlab-gift-unwrap`](evlab-gift-unwrap/) | Unwrap gift-FINAL (formerly "Unwrap your Everlab gift") — the gift page linked from a gift email: split-card layout, static dark by default, with Device, Theme and Motion tweaks | 2026-09-09, "Horizontal timeline, 64px gap" | Shared with organization |
...
| [`evlab-gift-split`](evlab-gift-split/) | Unwrap your Everlab gift · Split — the same file as `evlab-gift-unwrap` under its older title | 2026-09-09, "Horizontal timeline, 64px gap" | Private |
