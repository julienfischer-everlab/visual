...
**5.468 — "Add a small title with doctor and date, like this."** Each Explore card carries its source under the title, grey and small, with a short rule between the two: the doctor for a document (Dr Steven Lu · 14 Apr 2026 on the Dexa report, Dr Steven Lu on the questionnaire, Dr Edward Lim on the blood panel), the device for a device (Apple Watch · 9 Apr 2026; Oura ring · Syncing). One line in the card builder, so the phone's row and the desk's rail show it alike.
